...
if __name__ == "__main__":
    ...
    x_train = pd.read_csv(r'try_train_test_split_function\x_train_preprocessed.csv')
    x_test = pd.read_csv(r'try_train_test_split_function\x_test_preprocessed.csv')
    y_train = pd.read_csv(r'try_train_test_split_function\y_train.csv')
    y_test = pd.read_csv(r'try_train_test_split_function\y_test.csv')
